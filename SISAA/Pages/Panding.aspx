<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Panding.aspx.cs" Inherits="SISAA.Pages.Panding" %>
        ...
        <div class="card card-solid">
            <div class="card-body pb-10">
                <div class="row d-flex align-items-stretch">
                    <div class="col-9">
                        <div class="col-sm-9">
                            <h1>LISTA DE MENSAGENS PENDENTES</h1>
                        </div>
                    </div>
                    <div class="col-3">
                    </div>
